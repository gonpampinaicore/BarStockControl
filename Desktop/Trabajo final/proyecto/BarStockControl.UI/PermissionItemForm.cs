    ...
    public partial class PermissionItemForm : Form
    {
        ...
        private void LoadItems()
        {
            try
            {
                ...
                var dtos = items.Select(PermissionItemMapper.ToDto).ToList();
                dgvPermissionItems.DataSource = dtos;
            }
            catch (Exception ex)
            {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var errors = _permissionItemService.CreatePermissionItem(item);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var item = GetItemFromForm();
                item.Id = _selectedItemDto.Id;

                var errors = _permissionItemService.UpdatePermissionItem(item);
        ...
        private PermissionItem GetItemFromForm()
        {
            var dto = new PermissionItemDto
            {
