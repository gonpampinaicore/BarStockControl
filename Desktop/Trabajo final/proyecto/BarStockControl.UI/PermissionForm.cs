    ...
    public partial class PermissionForm : Form
    {
        ...
        private void LoadPermissions()
        {
            try
            {
                ...
                var dtos = permissions.Select(PermissionMapper.ToDto).ToList();
                dgvPermissions.DataSource = dtos;
            }
            catch (Exception ex)
            {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            try
            {
                var permission = GetPermissionFromForm();
                var errors = _permissionService.CreatePermission(permission);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var permission = GetPermissionFromForm();
                permission.Id = _selectedPermission.Id;

                var errors = _permissionService.UpdatePermission(permission);
                if (errors.Any())
                {
                    MessageBox.Show(string.Join("\n", errors), "Errores", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
        ...
        private Permission GetPermissionFromForm()
        {
